  ...
  useEffect(() => {
    async function getData() {
      const response = await fetch(
        "https://backend-project-l0bm1asm2-gabrielmarquezin.vercel.app/mercados/media"
      );
    ...
    <View style={styles.container}>
      <View style={styles.parteDeCima}>
        ...
        <Text style={styles.textoPequeno}>
          ESTA É A MÉDIA ATUAL DA CESTA BÁSICA:
        </Text>
      </View>
      <View style={styles.parteDeBaixo}>
        <View style={styles.bola}>
          <Text style={styles.precoDaTela}>
            {media ? media.mediaCesta.toFixed(2) : "..."}
          </Text>
        ...
        <View style={styles.escolha}>
          ...
          <TouchableOpacity
            style={styles.botaos}
            onPress={() => movingBetweenScreens("DEIRTON")}
          >
          ...
          <TouchableOpacity
            style={styles.botaos}
            onPress={() => movingBetweenScreens("BIGA")}
          >
          ...
          <TouchableOpacity
            style={styles.botaos}
            onPress={() => movingBetweenScreens("FRANCISCO")}
          >
          ...
          <TouchableOpacity
            style={styles.botaos}
            onPress={() => movingBetweenScreens("RUFINO")}
          >
            <Text style={styles.textBotaos}>SUPERMERCADO RUFINO</Text>
            <Shop fill="#fff" style={styles.shopIcon} />
          </TouchableOpacity>
        </View>
      </View>
